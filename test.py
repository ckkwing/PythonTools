...
# test1
# FolderCleaner.delete_files_by_suffix(r"F:\Temp2", constant.SUFFIX_IMAGE)
FolderCleaner.delete_files_except_suffix(r"F:\Temp2", constant.SUFFIX_IMAGE)
# FolderCleaner.clean_folder(r"F:\Temp2")
# test1
